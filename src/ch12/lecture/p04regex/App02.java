...
public class App02 {
    public static void main(String[] args) {
        System.out.println(Pattern.matches("a", "a")); // trye
        ...
        System.out.println(Pattern.matches("[a-z]", "t")); // 영문 소문자 한글자
        System.out.println(Pattern.matches("[A-Z]", "G")); // 영문 대문자 한글자
        System.out.println(Pattern.matches("[A-Z]", "h"));
        System.out.println(Pattern.matches("[0-9]", "3")); // 숫자
        System.out.println(Pattern.matches("[0-9A-Za-z]", "7")); // 숫자, 영문 대소문자
        System.out.println(Pattern.matches("[0-9A-Za-z]", "g"));
        System.out.println(Pattern.matches("[0-9A-Za-z]", "W"));
