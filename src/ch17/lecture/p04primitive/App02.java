...
public class App02 {
    public static void main(String[] args) {
        // 기본 타입 스트림<IntStream, LongStream, DoubleStream) -> 참조타입(Stream<T>)
        int[] arr1 = {1, 3, 5, 7, 9};
        ...
        // 참조타입(Stream<T>) -> 기본 타입 스트림<IntStream, LongStream, DoubleStream)
        // mapToInt, mapToLong, mapToDouble
        
        List<Integer> list1 = List.of(1, 3, 5, 7, 9);
        Stream<Integer> s3 = list1.stream();
        IntStream s4 = s3.mapToInt(Integer::intValue); // 참조타입 스트립 -> 기본타입 스트림
        long r2 = s4.count();
